...
int main(int argc, char const *argv[])
{
	...
	for(i=1; i<=12; ++i){
		...
		fprintf(out, "#PBS -r n\n");
		fprintf(out, "#PBS -l nodes=1:ppn=%d\n", i);
		fprintf(out, "#PBS -l walltime=00:01:00\n\n");
		fprintf(out, "cd $PBS_O_WORKDIR\n");
		fprintf(out, "time mpiexec ./HW1_101062319_basic_test 100000 randnum 100000_b_n1_p%d\n", i);
		fclose(out);
	}
	return 0;
}